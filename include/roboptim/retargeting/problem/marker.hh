#ifndef ROBOPTIM_RETARGETING_PROBLEM_MARKER_HH
# define ROBOPTIM_RETARGETING_PROBLEM_MARKER_HH
# include <string>
...
namespace roboptim
{
  namespace retargeting
  {
    namespace problem
    {
      /// \brief Define the optimization problem on marker (Euclidian)
      /// space.
      ///
...
#endif //! ROBOPTIM_RETARGETING_PROBLEM_MARKER_HH
